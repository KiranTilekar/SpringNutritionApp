...
<head>
    <meta charset="UTF-8">
    <title>Protein - Essential Nutrient Information</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <h1>Protein - Essential Nutrient</h1>

        <div class="section">
            <h2>What is Protein?</h2>
            <p>Protein is a macronutrient that is essential for building muscle mass, repairing tissue, making enzymes and hormones, and maintaining various body functions.</p>
        </div>

        <div class="section">
            <h2>Rich Protein Sources</h2>
            <div class="food-list">
                ...
                <div class="food-item">Legume</div>
                <div class="food-item">Rajgira</div>
        ...
        <div class="section">
            ...
            <div class="recommendation">
                <h3>For Men:</h3>
                <p>56 grams per day for the average sedentary man</p>
                <h3>For Women:</h3>
                <p>46 grams per day for the average sedentary woman</p>
                <p><em>Note: Athletes and active individuals may need more protein based on their activity level.</em></p>
            </div>
        </div>

        <div class="section">
            <h2>Effects of Protein Deficiency</h2>
            <div class="warning">
                <ul>
                    <li>Muscle weakness and loss</li>
        ...
        <div class="section">
            <h2>Effects of Protein Overdose</h2>
            <div class="warning">
                <ul>
                    <li>Kidney strain and potential damage</li>
                    <li>Dehydration</li>
                    <li>Digestive issues</li>
                    <li>Calcium loss from bones</li>
                    <li>Weight gain</li>
        ...
        <%
        // You can add dynamic content here, such as pulling protein information from a database
